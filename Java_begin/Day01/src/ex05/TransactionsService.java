...
public class TransactionsService {
    ...
    public void addTransactions(Integer idFirst, Integer idSecond, Integer transferAmount)
    ...
    Transaction deleteTransaction(Integer id, UUID identifier)
                                    throws UserNotFoundException, TransactionNotFoundException {
        Transaction operation = userlist.getUsersId(id).deleteTransactionUserList(identifier);
        return operation;
    }
