...
public class User {
    ...
    public void deleteTransactionUserList(UUID id)
            throws TransactionNotFoundException {
        this.arrayTransList.deleteTransaction(id);
    }

    public Transaction[] setArrayTransaction() {
        Transaction[] array = this.arrayTransList.toArray();
        return array;
    }
